...
import replica3.servers.CenterServerUDPThread;
...
public class ReplicaMgrService
{
	...
	public ReplicaMgrService()
	{
		...
		mtlUdpServThread = new CenterServerUDPThread(6799, mtlRecMgr);
		lvlUdpServThread = new CenterServerUDPThread(6800, lvlRecMgr);
		ddoUdpServThread = new CenterServerUDPThread(6801, ddoRecMgr);
