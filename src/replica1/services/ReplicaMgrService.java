...
public class ReplicaMgrService
{
	...
	public ReplicaMgrService()
	{
		...
		mtlUdpServThread = new CenterServerUDPThread(6791, mtlRecMgr);
		lvlUdpServThread = new CenterServerUDPThread(6792, lvlRecMgr);
		ddoUdpServThread = new CenterServerUDPThread(6793, ddoRecMgr);
